...
class Implementation_crypto(models.Model):
    ...
    config_specific_number = models.CharField(verbose_name=_("Configuration Specification Number"), max_length=50, null=False) 
    urs_number = models.CharField(verbose_name=_("URS Number"), max_length=50, null=False) 
    urs_status = models.CharField(verbose_name=_("URS Status"), max_length=50, null=False)
    operational_sop = models.CharField(verbose_name=_("operational_sop"), max_length=50, null=False)  
    operational_sop_number = models.CharField(verbose_name=_("Operational SOP Number"), max_length=50, null=False)
    maintaienance_sop_status = models.CharField(verbose_name=_("Maintenance SOP Status"), max_length=50, null=False)  
    maintaienance_sop_number = models.CharField(verbose_name=_("Maintenance SOP Number"), max_length=50, null=False)  
    admin_sop_status = models.CharField(verbose_name=_("Admin SOP Status"), max_length=50, null=False)   
    admin_sop_number = models.CharField(verbose_name=_("Admin SOP Number"), max_length=50, null=True) 
    logbook = models.CharField(verbose_name=_("Logbook"), max_length=50, null=False) 
    it_form_0024_status = models.CharField(verbose_name=_("IT-FRM-0024 Status"), max_length=50, null=False) 
    it_form_0024_number = models.CharField(verbose_name=_("IT-FRM-0024 Number"), max_length=50, null=False)   
